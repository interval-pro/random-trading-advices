    ...
    <section className="relative py-32 px-4 bg-gradient-to-b from-slate-950 via-black to-slate-950 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto text-center z-10">
        ...
        <p className="text-xl mb-16 text-gray-300 font-light">
          For just <span className="text-6xl font-bold text-amber-400">$5 USD</span>, receive one completely random trading recommendation
        </p>
        <div className="relative bg-gradient-to-br from-slate-800/90 via-slate-800/70 to-slate-900/90 backdrop-blur-xl rounded-3xl p-10 mb-12 border border-slate-700/50 shadow-2xl shadow-black/50 max-w-lg mx-auto">
          ...
          <div className="relative">
            <div className="text-7xl font-extrabold mb-8 bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">$5</div>
            <div className="space-y-4 mb-10 text-left">
              <div className="flex items-center gap-4">
                <div className="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-500/20">
            ...
            <button className="w-full bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold py-5 px-8 rounded-xl text-lg hover:from-amber-600 hover:to-amber-700 transition-all duration-300 shadow-2xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:-translate-y-0.5">
              Get Started - $5 USD
            </button>
            <p className="text-sm text-gray-400 mt-5 italic font-light">
