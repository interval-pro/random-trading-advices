    ...
    <section className="relative py-32 px-4 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="group relative bg-gradient-to-br from-slate-800/80 via-slate-800/60 to-slate-900/80 p-10 rounded-2xl border border-slate-700/50 backdrop-blur-xl shadow-2xl shadow-black/30 hover:border-amber-500/30 transition-all duration-300 hover:shadow-amber-500/10">
            ...
            <div className="relative">
              <div className="w-16 h-16 bg-gradient-to-br from-amber-500 to-amber-600 rounded-2xl flex items-center justify-center text-white font-bold text-2xl mb-6 shadow-lg shadow-amber-500/20">
                1
              </div>
              <h3 className="text-2xl font-bold mb-4 text-white">Random Stock Selection</h3>
          ...
          <div className="group relative bg-gradient-to-br from-slate-800/80 via-slate-800/60 to-slate-900/80 p-10 rounded-2xl border border-slate-700/50 backdrop-blur-xl shadow-2xl shadow-black/30 hover:border-amber-500/30 transition-all duration-300 hover:shadow-amber-500/10">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">Random Action Generation</h3>
              <p className="text-gray-300 leading-relaxed font-light">
          ...
          <div className="group relative bg-gradient-to-br from-slate-800/80 via-slate-800/60 to-slate-900/80 p-10 rounded-2xl border border-slate-700/50 backdrop-blur-xl shadow-2xl shadow-black/30 hover:border-amber-500/30 transition-all duration-300 hover:shadow-amber-500/10">
            ...
            <div className="relative">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">Receive Your Advice</h3>
              <p className="text-gray-300 leading-relaxed font-light">
